		...
		<div
				...
				@if (Route::has('login'))
						<div class="fixed top-0 right-0 hidden px-6 py-4 sm:block">
								...
								@else
										<a href="{{ route('login') }}" class="ml-4 text-sm text-gray-700 underline dark:text-gray-500">Login
												Operator</a>
										<a href="{{ route('login.wali') }}" class="ml-4 text-sm text-gray-700 underline dark:text-gray-500">Login Wali
												Murid</a>
